...
let recipe = json_recipes.recipes;

recipe.forEach((e) => {
  
  document.write("<h3>Id:</h3>"+ e.id + "<br>");
  document.write("<h3>Name:</h3>"+e.name + "<br>");
  document.write("<h3>Ingredients:</h3>"+e.ingredients + "<br><br>");
  document.write("<h3>Instructions:</h3>"+e.instructions + "<br>");
  document.write("<h3>prepTimeMinutes:</h3>"+e.prepTimeMinutes + "<br>");
  document.write("<h3>cookTimeMinutes:</h3>"+e.cookTimeMinutes + "<br>");
  document.write("<h3>serving:</h3>"+e.servings + "<br>");
  document.write("<h3>difficulty:</h3>"+e.difficulty + "<br>");
  document.write("<h3>cuisine:</h3>"+e.cuisine + "<br>");
  document.write("<h3>caloriesPerServing:</h3>"+e.caloriesPerServing + "<br>");
  document.write("<h3>tags:</h3>"+e.tags + "<br>");
  document.write("<h3>userId:</h3>"+e.userId + "<br>");
  document.write("<h3>image:</h3>"+e.image + "<br>");
  document.write("<h3>rating:</h3>"+e.rating + "<br>");
  document.write("<h3>reviewCount:</h3>"+e.reviewCount + "<br>");
  document.write("<h3>mealType:</h3>"+e.mealType + "<br>");
